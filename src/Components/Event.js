          ...
          <div className='container' id='event'>
              <div className='row'>
                <div className='six columns'>
                          ...
                          mobileTouch={false}
                        >
                        <div><iframe id="video_frame"  width="500" height="375"  src="https://www.youtube.com/embed/iEXIccvIADU" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe></div>
